...
def connectivityTest():
    ...
    thePing = subprocess.Popen('echo 1 > /proc/sys/net/ipv4/ip_forward', shell=True,stdout=PIPE, stderr=PIPE)
    print("Testing\nConnectivity")
...
def getPublicIP():
    publicIPUrl = urllib.urlopen("http://myip.com.tw/")
